...
const GenreFilm = ({ route, navigation }: any) => {
  ...
  const { ten_the_loai } = route.params;
  // const { Ty } = route.params;

  const fetchMovies = async (pageNumber: number, isRefresh = false) => {
    try {
      const response = await api.get(`the-loai/lay-du-lieu/${slug}?page=${pageNumber}`);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Danh sách phim {ten_the_loai}</Text>
